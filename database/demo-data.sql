...
VALUES
  ('M00000001', 'personal', 'Demo User One', 'demo.personal.one@example.test', '0900-000-001',
   '$2y$10$demoPasswordHashForLocalTestingOnly', 'active', 'A100000001', '1990-01-15', 'male',
   NULL, NOW(), NOW(), NOW()),
  ('M00000002', 'personal', 'Demo User Two', 'demo.personal.two@example.test', '0900-000-002',
   '$2y$10$demoPasswordHashForLocalTestingOnly', 'pending', 'B200000002', '1992-06-20', 'female',
   'demo-token-personal-two', NULL, NOW(), NOW()),
  ('M00000003', 'personal', 'Demo User Three', 'demo.personal.three@example.test', '0900-000-003',
...
INSERT INTO `members`
  (`member_code`, `type`, `name`, `email`, `phone`, `password`, `status`, `tax_id`, `company_name`, `website`, `industry`, `is_dealer`,
   `email_verified_token`, `email_verified_at`, `created_at`, `updated_at`)
VALUES
  ('M00000004', 'company', 'Demo Company Contact A', 'demo.company.a@example.test', '02-0000-0001',
   '$2y$10$demoPasswordHashForLocalTestingOnly', 'active', '00000001', 'Demo Alpha Co., Ltd.',
   'https://alpha.example.test', 'tech', 0, NULL, NOW(), NOW(), NOW()),
  ('M00000005', 'company', 'Demo Company Contact B', 'demo.company.b@example.test', '02-0000-0002',
   '$2y$10$demoPasswordHashForLocalTestingOnly', 'pending', '00000002', 'Demo Beta Studio',
   'https://beta.example.test', 'svc', 1, 'demo-token-company-b', NULL, NOW(), NOW()),
  ('M00000006', 'company', 'Demo Company Contact C', 'demo.company.c@example.test', '04-0000-0003',
   '$2y$10$demoPasswordHashForLocalTestingOnly', 'active', '00000003', 'Demo Retail Group',
   'https://retail.example.test', 'retail', 0, NULL, NOW(), NOW(), NOW());
