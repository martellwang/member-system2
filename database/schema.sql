...
CREATE TABLE IF NOT EXISTS `member_stores` (
  ...
  `contact_phone_area_code` VARCHAR(5) DEFAULT NULL COMMENT '聯絡人市話區碼',
  ...
  `integration_hash_key` VARCHAR(255) DEFAULT NULL,
  `integration_iv_key` VARCHAR(255) DEFAULT NULL,
  `integration_notify_url` VARCHAR(255) DEFAULT NULL,
  `integration_return_url` VARCHAR(255) DEFAULT NULL,
  `integration_test_mode` TINYINT(1) NOT NULL DEFAULT 0,
  `integration_credit_card_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_refund_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_token_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_non_card_refund_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_logistics_refund_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_linepay_refund_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_member_free_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_discount_refund_api_enabled` TINYINT(1) NOT NULL DEFAULT 0,
  `integration_street_payment_refund_api_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `integration_allowed_ips` TEXT DEFAULT NULL,
  `e_invoice_enabled` TINYINT(1) NOT NULL DEFAULT 0,
  `e_invoice_center` VARCHAR(100) DEFAULT NULL,
  `e_invoice_gift_unit` VARCHAR(30) DEFAULT NULL,
  `e_invoice_auto_issue` TINYINT(1) NOT NULL DEFAULT 1,
  `e_invoice_delay_days` TINYINT UNSIGNED DEFAULT NULL,
  `transaction_amount_limit_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `expired_refund_enabled` TINYINT(1) NOT NULL DEFAULT 0,
  `transaction_card_limit_mode` VARCHAR(20) NOT NULL DEFAULT 'off',
  `transaction_ip_limit_mode` VARCHAR(20) NOT NULL DEFAULT 'off',
  `marketing_enabled` TINYINT(1) NOT NULL DEFAULT 0,
  `marketing_notes` VARCHAR(400) DEFAULT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
