...
$router->get('api/admin/device-suppliers', 'AdminController', 'deviceSupplierList');
$router->post('api/admin/device-suppliers/create', 'AdminController', 'deviceSupplierCreate');
$router->post('api/admin/device-suppliers/{id}/update', 'AdminController', 'deviceSupplierUpdate');
$router->get('api/admin/store-code-prefixes/{memberId}', 'AdminController', 'storeCodePrefixShow');
$router->post('api/admin/store-code-prefixes/{memberId}', 'AdminController', 'storeCodePrefixSave');
$router->post('api/admin/store-code-prefixes/{memberId}/{prefixId}', 'AdminController', 'storeCodePrefixUpdate');
$router->get('api/admin/store-codes',    'AdminController', 'storeCodeList');
